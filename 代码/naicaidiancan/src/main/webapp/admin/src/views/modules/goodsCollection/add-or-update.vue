    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='goods'">
                    <el-form-item class="select" v-if="type!='info'"  label="商品信息" prop="goodsId">
                        <el-select v-model="ruleForm.goodsId" :disabled="ro.goodsId" filterable placeholder="请选择商品信息" @change="goodsChange">
                            <el-option
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="goodsCollectionTypes">
                        <el-select v-model="ruleForm.goodsCollectionTypes" :disabled="ro.goodsCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in goodsCollectionTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="goodsCollectionValue">
                        <el-input v-model="ruleForm.goodsCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    goodsId: false,
                    yonghuId: false,
                    goodsCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    goodsId: '',
                    yonghuId: '',
                    goodsCollectionTypes: '',
                    insertTime: '',
                },
                goodsCollectionTypesOptions : [],
                goodsOptions : [],
                yonghuOptions : [],
                rules: {
                   goodsId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=goods_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.goodsCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='goodsCollectionTypes'){
                          this.ruleForm.goodsCollectionTypes = obj[o];
                          this.ro.goodsCollectionTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`goodsCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.goodsCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
