...
public class GoodsCollectionView extends GoodsCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 类型的值
		*/
		private String goodsCollectionValue;
	...
	public GoodsCollectionView(GoodsCollectionEntity goodsCollectionEntity) {
		try {
			...
			* 获取： 类型的值
			*/
			public String getGoodsCollectionValue() {
				return goodsCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setGoodsCollectionValue(String goodsCollectionValue) {
				this.goodsCollectionValue = goodsCollectionValue;
			}
